<?php
/**
 * Template Name: Quotation Form
 * Description: Multi-step quotation form with basket functionality
 */
                ...
                <div class="card-grid category-grid">
                    <div class="image-card" data-category="windows">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/windows.jpg" alt="Windows">
                        </div>
                        <h3>Windows</h3>
                    </div>
                    <div class="image-card" data-category="doors">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/doors.jpg" alt="Doors">
                        </div>
                        <h3>Doors</h3>
                    </div>
                    <div class="image-card" data-category="bay-windows">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/bay-windows.jpg" alt="Bay Windows">
                        </div>
                        <h3>Bay Windows</h3>
                    </div>
                </div>
            ...
            <div class="sub-step" data-substep="1b-windows" data-parent-category="windows">
                ...
                <div class="card-grid type-grid">
                    <div class="image-card" data-type="casement" data-requires-material="true">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/casement-windows.jpg" alt="Casement Windows">
                        </div>
                        <h3>Casement Windows</h3>
                    </div>
                    <div class="image-card" data-type="flush" data-requires-material="true">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/flush-windows.jpg" alt="Flush Windows">
                        </div>
                        <h3>Flush Windows</h3>
                    </div>
                    <div class="image-card" data-type="tilt-turn" data-requires-material="true">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/tilt-turn.jpg" alt="Tilt & Turn">
                        </div>
                        <h3>Tilt & Turn</h3>
                    </div>
                    <div class="image-card" data-type="reversible" data-requires-material="false">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/reversible.jpg" alt="Reversible Window">
                        </div>
                        <h3>Reversible Window</h3>
                    </div>
                    <div class="image-card" data-type="sash" data-requires-material="false">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/sash-windows.jpg" alt="Sash Windows">
                        </div>
                        <h3>Sash Windows</h3>
                    </div>
                </div>
            ...
            <div class="sub-step" data-substep="1b-doors" data-parent-category="doors">
                ...
                <div class="card-grid type-grid">
                    <div class="image-card" data-type="bifold" data-requires-material="false">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/bifold-doors.jpg" alt="BiFold Doors">
                        </div>
                        <h3>BiFold Doors</h3>
                    </div>
                    <div class="image-card" data-type="french" data-requires-material="true" data-material-type="standard">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/french-doors.jpg" alt="French Doors">
                        </div>
                        <h3>French Doors</h3>
                    </div>
                    <div class="image-card" data-type="glazed" data-requires-material="true" data-material-type="standard">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/glazed-doors.jpg" alt="Glazed Doors">
                        </div>
                        <h3>Glazed Doors</h3>
                    </div>
                    <div class="image-card" data-type="sliding" data-requires-material="true" data-material-type="standard">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/sliding-doors.jpg" alt="Sliding Doors">
                        </div>
                        <h3>Sliding Doors</h3>
                    </div>
                    <div class="image-card" data-type="doorco" data-requires-material="true" data-material-type="doorco">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/doorco.jpg" alt="DoorCo">
                        </div>
                        <h3>DoorCo</h3>
                    </div>
                </div>
            ...
            <div class="sub-step" data-substep="1b-bay-windows" data-parent-category="bay-windows">
                ...
                <div class="card-grid type-grid">
                    <div class="image-card" data-type="casement-bays" data-requires-material="true" data-material-type="standard">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/casement-bays.jpg" alt="Casement Bays">
                        </div>
                        <h3>Casement Bays</h3>
                    </div>
                    <div class="image-card" data-type="flush-bays" data-requires-material="false">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/flush-bays.jpg" alt="Flush Bays">
                        </div>
                        <h3>Flush Bays</h3>
                    </div>
                    <div class="image-card" data-type="aluminium-casement-bays" data-requires-material="false">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/aluminium-casement-bays.jpg" alt="Aluminium Casement Bays">
                        </div>
            ...
            <div class="sub-step" data-substep="1c-material-standard">
                ...
                <div class="card-grid material-grid">
                    <div class="image-card" data-material="pvcu-chamfered">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/pvcu-chamfered.jpg" alt="PVCu Chamfered">
                        </div>
                        <h3>PVCu Chamfered</h3>
                    </div>
                    <div class="image-card" data-material="pvcu-decorative">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/pvcu-decorative.jpg" alt="PVCu Decorative">
                        </div>
                        <h3>PVCu Decorative</h3>
                    </div>
                    <div class="image-card" data-material="aluminium">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/aluminium.jpg" alt="Aluminium">
                        </div>
                        <h3>Aluminium</h3>
                    </div>
                </div>
            ...
            <div class="sub-step" data-substep="1c-material-doorco">
                ...
                <div class="card-grid material-grid">
                    <div class="image-card" data-material="traditional">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/doorco-traditional.jpg" alt="Traditional">
                        </div>
                        <h3>Traditional</h3>
                    </div>
                    <div class="image-card" data-material="designer">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/doorco-designer.jpg" alt="Designer">
                        </div>
                        <h3>Designer</h3>
                    </div>
                    <div class="image-card" data-material="contemporary">
                        <div class="card-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/doorco-contemporary.jpg" alt="Contemporary">
                        </div>
                        <h3>Contemporary</h3>
                    </div>
                </div>
        ...
        <div class="form-step" data-step="2">
            ...
            <div class="card-grid style-grid">
                ...
                <div class="image-card style-card" data-style="W<?php echo $i; ?>">
                    <div class="card-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/styles/w<?php echo $i; ?>.jpg" alt="Style W<?php echo $i; ?>">
                    </div>
                    <h3>W<?php echo $i; ?></h3>
                </div>
                <?php endfor; ?>
